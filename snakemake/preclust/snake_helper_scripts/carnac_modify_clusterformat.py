...
def main(args):
    ...
    reads = [acc for (acc, seq, qual) in readfq(open(args.flnc, 'r'))]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--flnc', type=str, help='Inferred clusters (tsv file)')
    parser.add_argument('--carnacfile', type=str, help='A sorted and indexed bam file.')
